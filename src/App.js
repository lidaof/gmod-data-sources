...
class App extends React.Component {
    async componentDidMount() {
        ...
        // console.log(tabData);
        const bw = new BigwigSource(
            "https://wangftp.wustl.edu/~cliu/data/rna-seq_BRep1/aligned/Trimmed_mRNA_93VU147T_HPV_R1.fastqAligned.sortedByCoord.out.forward.bigwig"
        );
        // const bw =  new BigwigSource('https://wangftp.wustl.edu/~dli/test/TW463_20-5-bonemarrow_MeDIP.bigWig');
        const bwData = await bw.getData("NC_001526.4", 7200, 7906);
